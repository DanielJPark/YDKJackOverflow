...
c1 = Category.create(title: "Category01" )
c2 = Category.create(title: "Category02" )
c3 = Category.create(title: "Category03" )
c4 = Category.create(title: "Category04" )
c5 = Category.create(title: "Category05" )
c6 = Category.create(title: "Category06" )
c7 = Category.create(title: "Category07" )
c8 = Category.create(title: "Category08" )
c9 = Category.create(title: "Category09" )
